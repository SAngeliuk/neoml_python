...
class Argmax(Dnn.Layer):
    ...
    Parameters
    ----------
    dimension : {'batch_length', 'batch_width', 'list_size', 'height', 'width', 'depth', 'channels'},
                default='channels'. The dimension along which the maximum is to be found.
"""
    ...
    @property
    def dimension(self):
        """Get a dimension along which the maximum is to be found.
        """
        return self.dimensions[self._internal.get_dimension()]

    @dimension.setter
    def dimension(self, dimension):
        """Set a dimension along which the maximum is to be found.
        """
        dimension_index = self.dimensions.index(dimension)
